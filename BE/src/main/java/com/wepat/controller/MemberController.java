...
public class MemberController {
    ...
    public ResponseEntity<?> modifyPwd(String memberId, String pwd) {
        try {
            return new ResponseEntity<>(memberService.modifyPwd(memberId, pwd), HttpStatus.OK);
        } catch (NotExistMember e) {
            throw new NotExistMember(e.getMessage());
        } catch (Exception e) {
            throw new RuntimeException(e.getMessage());
    ...
    public ResponseEntity<?> modifyMember(String memberId, String nickName) {
        try {
            return new ResponseEntity<>(memberService.modifyMember(memberId, nickName), HttpStatus.OK);
        } catch (NotExistMember e) {
            throw new NotExistMember(e.getMessage());
        } catch (Exception e) {
            throw new RuntimeException();
